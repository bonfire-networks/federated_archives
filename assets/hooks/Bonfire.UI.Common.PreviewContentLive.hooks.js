/*
Synced from deps/bonfire_ui_common/lib/components/modals/preview_content_live.hooks.js
(federated_archives flavour). Keep in lockstep with upstream; only add PanDoRa-specific
exclusions in shouldHandlePreviewClick so feed video previews / Plyr are not treated as
preview navigation (see pandora-video-preview-wrapper).
*/
...
function shouldHandlePreviewClick(e, trigger, pointerState) {
  ...
  // PanDoRa feed video previews (HtmlBodyPreprocessor + Plyr): never open activity preview
  if (
